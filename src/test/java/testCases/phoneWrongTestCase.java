...
public class phoneWrongTestCase extends pageBaseClass{
	...
	public void submitForm(String browser) throws IOException {
		//Took data from Excel sheet using Apache POI
				...
				String name = formatter.formatCellValue(sheet.getRow(12).getCell(0));
				String organizationName = formatter.formatCellValue(sheet.getRow(12).getCell(1));
				String email = formatter.formatCellValue(sheet.getRow(12).getCell(2));
				String phone = formatter.formatCellValue(sheet.getRow(12).getCell(3));
				String size = formatter.formatCellValue(sheet.getRow(12).getCell(4));
				
				//Closed the workbook
				workbook.close();
				
				//Extent report initialization
				logger = report.createTest("Search for hospitals Test 3");
